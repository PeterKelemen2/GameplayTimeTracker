...
public class AppAnimations
{
    ...
    public static DoubleAnimation DragFadeIn = new DoubleAnimation
    {
        From = 0,
        To = 1,
        Duration = TimeSpan.FromSeconds(dragAnimDuration),
        EasingFunction = new CubicEase { EasingMode = EasingMode.EaseOut }
    };

    public static DoubleAnimation DragFadeOut = new DoubleAnimation
    {
        From = 1,
        To = 0,
        Duration = TimeSpan.FromSeconds(dragAnimDuration),
    ...
    public static DoubleAnimation FadeInMainPanel = new DoubleAnimation
    {
        From = 0,
        To = 1,
        Duration = TimeSpan.FromSeconds(fadeMainPanelDuration),
        EasingFunction = new CubicEase { EasingMode = EasingMode.EaseIn }
    };

    public static DoubleAnimation FadeOutMainPanel = new DoubleAnimation
    {
        From = 1,
        To = 0,
        Duration = TimeSpan.FromSeconds(fadeMainPanelDuration),
